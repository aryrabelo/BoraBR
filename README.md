...
>
> **This project's successor is [PaiR](https://pair.w3dev.fr)** — latest release: **[v0.7.1](https://github.com/w3dev33/pair-dist/releases/tag/v0.7.1)** for macOS (ARM64 + Intel), Linux (amd64 + arm64), and Windows.
>
